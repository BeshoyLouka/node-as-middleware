...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(((stack1 = helpers.json || (depth0 && depth0.json)),stack1 ? stack1.call(depth0, (depth0 && depth0.appData), options) : helperMissing.call(depth0, "json", (depth0 && depth0.appData), options)))
    + ");\n      App.bootstrapData(";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.json || (depth0 && depth0.json)),stack1 ? stack1.call(depth0, (depth0 && depth0.bootstrappedData), options) : helperMissing.call(depth0, "json", (depth0 && depth0.bootstrappedData), options)))
    + ");\n      App.start();\n    })();\n    </script>\n\n  </body>\n\n</html>\n";
  return buffer;
  });
var Handlebars = require("handlebars");module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  else { stack1 = (depth0 && depth0.watchers_count); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</td>\n      <td>";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.copyright || (depth0 && depth0.copyright)),stack1 ? stack1.call(depth0, "2013", options) : helperMissing.call(depth0, "copyright", "2013", options)))
    + "</p>\n";
  return buffer;
  });
var Handlebars = require("handlebars");module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack2)
    + "/builds/"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.build)),stack1 == null || stack1 === false ? stack1 : stack1.last_build_id)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
  ...
  buffer += escapeExpression(stack2)
    + "<br>\n\n\n";
  stack2 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.build)),stack1 == null || stack1 === false ? stack1 : stack1.last_build_id), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  ...
  else { stack2 = (depth0 && depth0.forks_count); stack2 = typeof stack2 === functionType ? stack2.call(depth0, {hash:{},data:data}) : stack2; }
  buffer += escapeExpression(stack2)
    + "</td>\n      </tr>\n      <tr>\n        <th>Open Issues</th>\n        <td>";
  if (stack2 = helpers.open_issues_count) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = (depth0 && depth0.open_issues_count); stack2 = typeof stack2 === functionType ? stack2.call(depth0, {hash:{},data:data}) : stack2; }
  buffer += escapeExpression(stack2)
    + "</td>\n      </tr>\n    </table>\n  </div>\n</div>\n";
  return buffer;
  });
...
function program1(depth0,data) {
  ...
  else { stack1 = (depth0 && depth0.login); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">";
  if (stack1 = helpers.login) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.login); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  else { stack1 = (depth0 && depth0.avatar_url); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "\" width=80 height=80> ";
  if (stack1 = helpers.login) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.login); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  ...
  else { stack1 = (depth0 && depth0.public_repos); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + " public repos)\n\n<br>\n\n<div class=\"row\">\n  <div class=\"col-lg-6 col-md-6 col-sm-6\">\n    ";
  options = {hash:{
    'collection': ((depth0 && depth0.repos))
  },data:data};
  buffer += escapeExpression(((stack1 = helpers.view || (depth0 && depth0.view)),stack1 ? stack1.call(depth0, "user_repos_view", options) : helperMissing.call(depth0, "view", "user_repos_view", options)))
  ...
  else { stack2 = (depth0 && depth0.blog); stack2 = typeof stack2 === functionType ? stack2.call(depth0, {hash:{},data:data}) : stack2; }
  buffer += escapeExpression(stack2)
    + "</td>\n      </tr>\n    </table>\n  </div>\n</div>\n";
  return buffer;
  });